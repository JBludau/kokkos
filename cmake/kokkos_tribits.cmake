...
function(KOKKOS_SET_LIBRARY_PROPERTIES LIBRARY_NAME)
  ...
  target_compile_options(
    ${LIBRARY_NAME} PUBLIC $<$<COMPILE_LANGUAGE:${KOKKOS_COMPILE_LANGUAGE},CXX>:${KOKKOS_COMPILE_OPTIONS}>
  )

  target_compile_definitions(
    ${LIBRARY_NAME} PUBLIC $<$<COMPILE_LANGUAGE:${KOKKOS_COMPILE_LANGUAGE},CXX>:${KOKKOS_COMPILE_DEFINITIONS}>
  )
  ...
  if(KOKKOS_ENABLE_CUDA)
    target_compile_options(
      ${LIBRARY_NAME} PUBLIC $<$<COMPILE_LANGUAGE:${KOKKOS_COMPILE_LANGUAGE},CXX>:${KOKKOS_CUDA_OPTIONS}>
    )
  ...
  if(KOKKOS_ENABLE_HIP)
    target_compile_options(
      ${LIBRARY_NAME} PUBLIC $<$<COMPILE_LANGUAGE:${KOKKOS_COMPILE_LANGUAGE},CXX>:${KOKKOS_AMDGPU_OPTIONS}>
    )
