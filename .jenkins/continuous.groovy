                ...
                stage('CUDA-12.2-NVCC-RDC') {
                    ...
                    steps {
                        ...
                        sh '''#!/bin/bash
                              ...
                              make -j8 && ctest --verbose && \
                              cd ../.. && \
                              cmake -B build_cmake_installed_mark_non_kokkos_files/build -DCMAKE_CXX_COMPILER=clang++ -DCMAKE_CXX_FLAGS=-Werror -DCMAKE_CXX_STANDARD=20 build_cmake_installed_mark_non_kokkos_files && \
